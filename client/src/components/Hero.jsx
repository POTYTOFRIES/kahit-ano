    ...
    <div className='max-w-[1640px] mx-auto p-4'>
        <div className='max-h-[500px] relative'>
            ...
            <div className='absolute w-full h-full text-gray-200 max-h-[500px] rounded-3xl bg-black/40 flex flex-col justify-center'>
                <h1 className='px-8 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold'>Can't <span className='text-amber-600'>Decide</span></h1>
                <h1 className='px-8 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold'> <span className='text-green-700'>What</span> To Eat?</h1>
            </div>
