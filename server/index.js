...
app.post('/add-post', (request, response) => {
  const { title, body, category_id, photo, rate, created_at, edited_at, deleted_at} = request.body

  pool.query('INSERT INTO posts (title, body, category_id, photo, rate, created_at, edited_at, deleted_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', [title, body, category_id, photo, rate, created_at, edited_at, deleted_at], (error, results) => {
    if (error) {
      throw error;
  }
